...
echo "... creating ./ssl/${APP}.key"
openssl genrsa -out ./ssl/${APP}.key 2048

echo "... creating ./ssl/${APP}.csr"
...
EOF
echo "openssl req -new -key ./ssl/${APP}.key -subj \"/CN=${CSR_NAME}\" -out ./ssl/${APP}.csr -config ./ssl/csr.conf"
...
echo "... creating ./ssl/${APP}.pem cert file"
